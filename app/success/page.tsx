...
export default function SuccessPage() {
  ...
  return (
    <div className="h-[100svh] bg-gradient-to-br from-blue-500 to-purple-600 flex flex-col items-center justify-center">
      ...
      <div className="py-6">
        ...
        >
          <span className="relative z-10 text-white transition-colors group-hover:text-purple-800">
            ENJOY
          </span>
